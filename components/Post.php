...
class Post extends ComponentBase
{
    ...
    {
        return [
            'name' => 'wixcore.blog::lang.settings.post_title',
            'description' => 'wixcore.blog::lang.settings.post_description'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'slug' => [
                'title' => 'wixcore.blog::lang.settings.post_slug',
                'description' => 'wixcore.blog::lang.settings.post_slug_description',
                'default' => '{{ :slug }}',
                'type' => 'string',
            ],
            'categoryPage' => [
                'title' => 'wixcore.blog::lang.settings.post_category',
                'description' => 'wixcore.blog::lang.settings.post_category_description',
                'type' => 'dropdown',
    ...
    protected function loadPost()
    {
        ...
        if ($post->isClassExtendedWith('WixCore.Translate.Behaviors.TranslatableModel')) {
    ...
    protected function checkEditor()
    {
        ...
        return $backendUser && $backendUser->hasAccess('wixcore.blog.access_posts');
    }
}
